...
+ Присутствует возможность добавления картинок или таблиц

+ Выставление оценки в заданном диапазоне после окончания

+ Защита тестов и их настроек от изменения паролем


2. [ADTester](https://www.adtester.org/) (рис. 2)
...
3. [Moodle](https://moodle.org/) (рис.3 a, б)

![](https://github.com/AnastasiaZorall/Auto-test-generation-system/blob/master/images/moodle1.jpg) ![](https://github.com/AnastasiaZorall/Auto-test-generation-system/blob/master/images/moodle2.png)
...
1. Математические основы ВТ (Действия с числами в разных системах счисления)
  + Перевод из одной системы счисления в другую
    + Перевод целых чисел из 10-ичной системы в 2-ичную систему счисления
    + Перевод целых чисел из 2-ичной системы в 10-ичную систему счисления
    + Перевод целых чисел из одной системы счисления в другую
    + Перевод чисел с плавающей запятой
  + Перевод целых чисел в дополнительный код
  + Двоичная арифметика с целыми числами
2. Логические основы ВТ (Алгебра логики)
  + Приведение к совершенной нормальной форме
    + Приведение к совершенной конъюнктивной нормальной форме (СКНФ)
    + Приведение к совершенной дизъюнктивной нормальной форме (СДНФ)
  + Приведение к минимальной нормальной форме
    + Приведение к минимальной конъюнктивной нормальной форме (МКНФ)
    + Приведение к минимальной дизъюнктивной нормальной форме (МДНФ)
  + Операции булевой алгебры
3. Основы теории информации
  + Применение формулы сочетания без повторений
  + Применение формулы сочетания с повторениями
  + Применение формулы размещения без повторений
  + Применение формулы размещения с повторениями
...
![](https://github.com/AnastasiaZorall/Auto-test-generation-system/blob/master/images/work1.png)
...
![](https://github.com/AnastasiaZorall/Auto-test-generation-system/blob/master/images/work5.png)
...
![](https://github.com/AnastasiaZorall/Auto-test-generation-system/blob/master/images/work6.png)

Рис. 9. Вид оконной формы после завершения записи заданий в файл

Для выполнения одного из описанных выше требований к системе, при активации checkbutton производится проверка введенного числа заданий на допустимость. Допустимыми для ввода считаются только натуральные числа. Поскольку это требование является естественным, дополнительная подсказка пользователю до ввода не является необходимой. В случае ошибки при введении количества заданий запись заданий в файл не производится и на экран выводится текст «Only integer numbers are available» (рис. 10).

![](https://github.com/AnastasiaZorall/Auto-test-generation-system/blob/master/images/work7.png)
...
Название файлов с заданиями для учащегося строится по следующему принципу: <введённое пользователем название > + <номер варианта по порядку> + .docx
...
![](https://github.com/AnastasiaZorall/Auto-test-generation-system/blob/master/images/task1.png)

Рисунок 11. Файл с заданиями для студентов

![](https://github.com/AnastasiaZorall/Auto-test-generation-system/blob/master/images/task2.png)
...
На вход функции передаётся строка, которая проверяется на то, является ли она натуральным числом. На выход функции подаётся ложь или истина в зависимости от строки.
  ...
  + Функция, выводящая подсказку для пользователя о введении неверного значения строки
```
